...
const record: MissionRecord = {
  ...
  teamBinding: {
    ...
    members: [
      { agentId: "boss", principalId: "principal-boss", capabilities: ["mission:intake"], enabledTools: [] },
      { agentId: "dev", principalId: "principal-dev", capabilities: ["delivery:implement"], enabledTools: [] },
    ],
  },
  status: "starting",
};
