...
describe("health", () => {
  it("returns AutoAgent health", async () => {
    ...
    expect(response.body).toEqual({
      ...
      evolution: { running: false, evaluatorConfigured: false, evaluationMode: "unavailable", releaseBlockers: [], workspacesScanned: 0, reflectionSignalsProcessed: 0, dreamPracticesProduced: 0, practiceBindingsCreated: 0, scopePromotionArtifactsCreated: 0, evaluationJobsProcessed: 0, promotionTransitionsProcessed: 0 },
    });
  });
